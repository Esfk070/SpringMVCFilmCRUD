...
<body>
	...
	<table>
		<tr>
			<td>
				...
				<form action="getFilmById.do" method="get">
					<label for="filmId">Enter the ID:</label> 
					<input id="filmId" name="filmId" type="text" /> 
				...
				<form action="addFilm.do" method="post">
					<table>
						<tr>
							...
							<td><input id="filmTitle" name="filmTitle" type="text" required /></td>
						</tr>
						<tr>
							<td><label for="filmDescription">Description:</label></td>
							<td><input id="filmDescription" name="filmDescription" type="text" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input id="languageId" name="languageId" type="number" required /></td>
						</tr>
						<tr>
							<td><label for="rentalDuration">Rental Duration:</label></td>
							<td><input id="rentalDuration" name="rentalDuration" type="number" required /></td>
						</tr>
						<tr>
							<td><label for="rentalRate">Rental Rate:</label></td>
							<td><input id="rentalRate" name="rentalRate" type="number" step="0.01" required /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input id="replacementCost" name="replacementCost" type="number" step="0.01" required /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input id="specialFeatures" name="specialFeatures" type="text" /></td>
						</tr>
						<tr>
		...
		<tr>
			<td colspan="2">
				<!-- Moved the Delete Film to the Bottom For Better UX-->
				<h2>Delete Film by ID</h2>
				<form action="deleteFilm.do" method="post">
					Delete by Film ID: <input name="filmId" type="text" /> 
